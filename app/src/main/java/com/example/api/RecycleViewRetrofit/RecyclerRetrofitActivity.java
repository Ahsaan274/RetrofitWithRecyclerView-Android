package com.example.api.RecycleViewRetrofit;
...
public class RecyclerRetrofitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_retrofit);
    ...
    private void writeRecycler(String response){
        ...
        try {
            ...
            if(obj.optString("status").equals("true")){
                ...
                Toast.makeText(RecyclerRetrofitActivity.this, obj.optString("message")+"", Toast.LENGTH_SHORT).show();
            }
