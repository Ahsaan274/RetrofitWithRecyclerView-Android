...
public class RetrofitJsonListView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrofit_json_list_view);
        ...
        call.enqueue(new Callback<List<Spacecraft>>() {
            ...
            public void onFailure(Call<List<Spacecraft>> call, Throwable throwable) {
                myProgressBar.setVisibility(View.GONE);
                Toast.makeText(RetrofitJsonListView.this, throwable.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}